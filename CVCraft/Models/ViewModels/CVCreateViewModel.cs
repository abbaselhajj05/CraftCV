...
namespace CVCraft.Models.ViewModels {
    public class CVCreateViewModel {
        ...
        [Required(ErrorMessage = "Please solve the verification problem")]
        [Display(Name = "Sum")]
        ...
        public CVCreateViewModel() {
            var random = new Random();
            VerificationOperand1 = random.Next(1, 50);
            VerificationOperand2 = random.Next(1, 50);
