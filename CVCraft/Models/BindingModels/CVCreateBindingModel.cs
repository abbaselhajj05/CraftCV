...
namespace CVCraft.Models.BindingModels {
    public class CVCreateBindingModel {
        ...
        [Required(ErrorMessage = "Verification operand 1 is required")]
        [Range(1, 100, ErrorMessage = "Operand 1 must be between 1 and 100")]
        [Display(Name = "Operand 1")]
        public int VerificationOperand1 { get; set; }

        [Required(ErrorMessage = "Verification operand 2 is required")]
        [Range(1, 100, ErrorMessage = "Operand 2 must be between 1 and 100")]
        [Display(Name = "Operand 2")]
        public int VerificationOperand2 { get; set; }

        [Required(ErrorMessage = "Verification sum is required")]
        [Range(2, 200, ErrorMessage = "Sum must be between 2 and 200")]
        [Display(Name = "Sum")]
        public int VerificationSum { get; set; }
